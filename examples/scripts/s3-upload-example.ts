...
Generated by: OpenAgentic Framework
    ...
    const result: UploadResult = await uploadFileWithDetails(
      ...
      textFileName,
      {
        directory: S3Directory.DOCUMENTS,
  ...
  try {
    ...
    const files: Array<{buffer: Buffer, fileName: string, options?: UploadOptions}> = [
      {
        buffer: Buffer.from('File 1 content - JSON data', 'utf-8'),
        fileName: 'test-file-1.json',
        options: { directory: S3Directory.DOCUMENTS, description: 'Test JSON file' }
      },
      {
        buffer: Buffer.from('File 2 content - Plain text', 'utf-8'),
        fileName: 'test-file-2.txt',
        options: { directory: S3Directory.DOCUMENTS, description: 'Test text file' }
      },
      {
        buffer: Buffer.from('<xml><test>File 3 content</test></xml>', 'utf-8'),
        fileName: 'test-file-3.xml',
        options: { directory: S3Directory.DOCUMENTS, description: 'Test XML file' }
      }
    ];
